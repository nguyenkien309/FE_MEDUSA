          ...
          return (
            <div key={collection.id} className="">
              <button
                ...
                className={`${index === activeIndex? 'bg-black text-white': 'bg-[#FAFAFA] text-[#8A8A8A]'} duration-200 transition-all rounded-md border-none outline-none w-[207px] h-14  hover:bg-black  hover:text-white text-base font-volkhov`}
              >
                {collection.title}
              </button>
            </div>
